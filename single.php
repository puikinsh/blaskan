	...
	<div id="primary" class="content-area row">
		...
		while ( have_posts() ) : the_post();
			...
			if ( !empty( $current_post_categories ) ) {
				...
				$related_posts = new WP_Query( array( 'category__in' => $current_post_categories, 'posts_per_page' => 3 ) );
				if ( $related_posts->have_posts() ) {
					
					echo '<div class="related-posts row">';
					echo '<div class="related-header col-md-12"><h5>'.__( 'Similar Posts', 'blaskan' ).'</h5></div>';
