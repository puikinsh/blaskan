...
if used_brands:
    ...
    # Name the family outright. Font Awesome defines --fa-family-brands in
    # brands.min.css, which the subset deliberately does not load, so referring to the
    # variable here leaves it undefined and every .fa-brands icon silently falls back
    # to the Free family and renders the wrong glyph.
